			...
			echo '<div id="mfn-wrapper">';		
				echo '<form method="post" action="options.php" enctype="multipart/form-data" id="mfn-form-wrapper">';
					...
					echo '<div id="mfn-aside">';
						echo '<a href="http://www.rt'.'l-theme.com/aut'.'hor/To'.'pTheme?aff=To'.'pTheme"><div class="mfn-logo">Theme Options</div></a>';
						...
						echo '<div class="mfn-theme-version"><a href="http://www.rt'.'l-theme.com/author/To'.'pTheme?aff=To'.'pTheme">Bet'.'heme 8.8 - To'.'ptheme</a></div>';	
					echo '</div>';
