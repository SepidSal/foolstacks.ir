 ...
 *
 * @package Betheme
 * @author TopTheme - toptheme@rayanic.ir
 * @link http://www.rtl-theme.com/author/TopTheme?aff=TopTheme
 */
...
define( 'THEME_VERSION', '8.8' );

define( 'LIBS_DIR', THEME_DIR. '/functions' );
define( 'LIBS_URI', THEME_URI. '/functions' );
define( 'LANG_DIR', THEME_DIR. '/functions/importer/lg' );
...
if( ! isset( $post_types_disable['template'] ) ){	// not implemented
